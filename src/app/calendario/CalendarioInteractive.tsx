...
interface CalendarioInteractiveProps {
  initialIsPro: boolean;
  userName: string;
  userId: string;
}

export default function CalendarioInteractive({ initialIsPro, userName: initialUserName, userId }: CalendarioInteractiveProps) {
